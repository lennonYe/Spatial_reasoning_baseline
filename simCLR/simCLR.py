...
from custom_dataset import SimCLRDataset,CustomImagePairDataset
...
def load_config(config_path='config_simclr.yaml'):
...
test_dataset = CustomImagePairDataset(root_dir,test_scenes)
...
optimizer = torch.optim.Adam(simclr_model.parameters(), lr=config['learning_rate'])
